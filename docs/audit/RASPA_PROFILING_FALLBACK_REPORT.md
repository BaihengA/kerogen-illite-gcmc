# RASPA Profiling Fallback Report

status: PASS_WITH_LIMITATIONS

- perf: NOT_AVAILABLE
- strace: AVAILABLE_AND_RUN
- gdb: NOT_AVAILABLE
- /proc/PID/task/*/stack: PERMISSION_DENIED
...
Thread CPU sampling was collected in `diagnostics/perf/thread_cpu_samples.csv`. Stack sampling was denied by kernel permissions; see `diagnostics/perf/proc_stack_samples.txt`.

system_call_block: NO_STRONG_EVIDENCE

The fallback data cannot provide symbol-level CPU hotspots.
